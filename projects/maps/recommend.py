...
def find_closest(location, centroids):
    ...
    # BEGIN Question 3
    "*** YOUR CODE HERE ***"
    return min(centroids, key = lambda item: distance(location, item))
    # END Question 3
...
def group_by_centroid(restaurants, centroids):
    ...
    for item in restaurants:
        ...
        first_used.append([closest_centroid, item])
    return group_by_first(first_used)
    # END Question 4
...
def find_predictor(user, restaurants, feature_fn):
    ...
    # BEGIN Question 7
    diff_x = [x - mean(xs) for x in xs]
    diff_y = [y - mean(ys) for y in ys]
...
def rate_all(user, restaurants, feature_fns):
    ...
    # BEGIN Question 9
    "*** YOUR CODE HERE ***"
    return {restaurant_name(rest): user_rating(user, restaurant_name(rest)) if rest in reviewed else predictor(rest) for rest in restaurants}
    # END Question 9
