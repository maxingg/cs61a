...
CREATE TABLE by_height AS
  SELECT d1.name from dogs as d1, dogs as d2, parents where d1.name = child and d2.name = parent order by d2.height desc;
...
CREATE TABLE sentences AS
  SELECT name1 || " and " || name2 || " are " || size1.size || " siblings" from siblings, size_of_dogs as size1, size_of_dogs 
  as size2 where name1 = size1.name and name2 = size2.name and size1.size = size2.size;
